 ...
 * 檔頭（C169 §一）。它接在 `scripts.ready` 上而**不在** `scripts.gate` 上：
 ...
 * 這一條由 `tools/gate-kit/tests/adoption.test.ts` 守著，而那份名冊是從
 * `scripts.gate ＋ scripts.ready` 推導的，所以接上 `ready` 的同時它就進了名冊。
 */
