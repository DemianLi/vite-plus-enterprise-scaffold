...
export const GATES: readonly Gate[] = [
  ...
  },
  {
    id: "api-surface",
    kind: "gate",
    what: "platform/ 公開 API 的破壞性變更：export 名稱＋**型別形狀**（元件的 props 就在形狀裡）（D12）",
