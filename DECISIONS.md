...
| 檔案                                       |                                                                                                 |
| ------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| `tools/api-surface/src/tracked.ts`         | **新增** —— `trackedPackageDirs()`、`phantomEntryPoints()`、`PHANTOM_REMEDIATION`               |
...
| `tools/api-surface/tests/tracked.test.ts`  | **新增** 11 條                                                                                  |
| `tools/api-surface/tests/negative.test.ts` | 新增 4 條（66 → **69**），全檔合計 **80**                                                       |
