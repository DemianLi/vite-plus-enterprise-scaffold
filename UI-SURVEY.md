...
| 供應鏈閘門（565 套件／144 原生二進位進版控）  | 每個新相依都要進盤點；新的**原生二進位家族**要 PR ＋ CODEOWNERS |
...
而現在三條軸只有一條有接縫、且只覆蓋 16 處顏色宣告裡的 5 處
（HANDOFF **第 24 項**，那裡附了重新推導這個數字的指令）。
**重新評估 UI 方案時，這一題要一起問** —— multi-brand 的需求會改變評分。
